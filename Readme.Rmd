...
- Data: This subfolder contains the data. The file `SP-off-RP data.rds` contains the data in R format, and is the file data that is called by other files. The subfolder also contain the excel `SP-off-RP data.xlsx` for users interested in reading the data in a different format.
